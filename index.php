...
<div class="container">
    ...
    <div class="panel">
        ...
        <ul>
            <?php
            foreach (SiteController::listAction() as $site) {
        ...
        <form name="review-form" method="post" action="review.php">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button name="cmd" type="submit" value="update">Update the sites</button>
            <br/><br/>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button name="cmd" type="submit" value="unittest-review">Unit test on review</button>
            <br/><br/>
        </form>
    </div>
    <div class="social">
